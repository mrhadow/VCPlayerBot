...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/at3_movies'),
            InlineKeyboardButton('🧩 Source', url='https://t.me/newrcbot')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://github.com/mrhadow/VCPlayerBot'),
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/at3_movies'),     
        ],
        [
            InlineKeyboardButton("🎞 How to Deploy", url='https://www.instagram.com/invites/contact/?i=kp6810fbu95r&utm_content=lwqtx3n'),
            InlineKeyboardButton('🗑 Close', callback_data='close'),
        ]
    ]
    await message.reply("<b>The source code of this bot is public and can be found at <a href=https://t.me/at3_movies.</a>\nYou can deploy your own bot and use in your group.\n\nFeel free to star☀️ the repo if you liked it 🙃.</b>", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
    await delete_messages([message])
